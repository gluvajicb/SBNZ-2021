...
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (35, "Rabadon's Deathcap", true, true, true, false, false, true, 4, 1, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (36, "Morellonomicon", true, true, true, false, true, false, 4, 1, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (37, "Maw of Malmortious", true, true, false, true, false, true, 4, 0, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (38, "Guardian's Angel", true, true, false, true, true, false, 4, 0, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (39, "Spirit Visage", false, true, true, true, false, true, 4, 4, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (40, "Thornmail", false, true, true, true, true, false, 4, 4, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (41, "Mercurial Scimitar", true, true, false, true, false, true, 4, 2, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (42, "Bloodthirster", true, true, false, true, true, false, 4, 2, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (43, "Gargoyle Stoneplate", false, true, true, true, false, true, 4, 5, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (44, "Frozen Heart", false, true, true, true, true, false, 4, 5, 0);

/* offensive items */

insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (45, "Void Staff", true, false, true, false, false, false, 5, 1, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (46, "Mejai's Soulstealer", true, false, true, false, false, false, 5, 0, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (47, "Youmuu's Ghostblade", true, false, false, true, false, false, 5, 0, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (48, "Abysall Mask", true, true, true, false, false, true, 5, 4, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (49, "Dead Man's Plate", true, true, false, true, true, false, 5, 4, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (50, "Rylai's Crystal Scepter", true, true, true, false, false, false, 5, 3, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (51, "Black Cleaver", true, true, false, true, false, false, 5, 3, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (52, "Infinity Edge", true, false, false, true, false, false, 5, 2, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (53, "Knight's Vow", true, true, true, false, true, true, 5, 5, 0);
insert into items (id, name, is_offensive, is_defensive, is_for_ap, is_for_ad, is_armor, is_magic_resist, item_slot, for_class, good_against_class)
    values (54, "Mikael's Blessing", true, true, false, true, true, true, 5, 5, 0);