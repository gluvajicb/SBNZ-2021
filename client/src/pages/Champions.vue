    ...
    export default {
        ...
        methods: {
            ...
            async submit() {
                ...
                await AXIOS.post('/champion-recommender', championAnswers)
                    .then(response => {console.log(response.data)

                      try{
                        const firstPick = response.data.firstPick;
                        const secondPick = response.data.secondPick;
                        const thirdPick = response.data.thirdPick;
